...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Texturizado - Sadam Lopez", nullptr, nullptr);
	...
	// Diffuse map
	image = stbi_load("images/dado_jslg.png", &textureWidth, &textureHeight, &nrChannels,0);
	glBindTexture(GL_TEXTURE_2D, texture1);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//model2 = glm::translate(model2, glm::vec3(0.0f, 0.0f, 2.0f)); // mover 1 unidad en X
